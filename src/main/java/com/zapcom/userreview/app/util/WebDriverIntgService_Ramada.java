...
public class WebDriverIntgService_Ramada {

	public static final Logger logger = LoggerFactory.getLogger(WebDriverIntgService_Ramada.class);
	...
	public static synchronized void extractDataFromTripAdvisor(WebDriver driver) throws Exception {
		...
		driver.findElement(By.id("mainSearch")).sendKeys("Ramada Caravela Beach Resort");
		waitForLoad(driver);
	...
	//	facilitiesLinks.forEach(link -> System.out.print(link.getText() + " "));
		...
		System.out.println(
				"Review's heading is : " + driver.findElement(By.xpath("//*[@id='rn337502116']/span")).getText());
		System.out.println("Reviewer's rating is : "
				+ driver.findElement(By.xpath("//*[@id='review_337502116']/div/div[2]/div/div/div[2]/span[1]/img"))
						.getAttribute("alt"));
		System.out.println("Review's date is : "
				+ driver.findElement(By.xpath("//*[@id='review_337502116']/div/div[2]/div/div/div[2]/span[2]"))
						.getAttribute("title"));
